...
[View this notebook.](http://nbviewer.jupyter.org/github/gwu-libraries/notebooks/blob/master/20170720-building-social-network-graphs-JSON.ipynb)

![Extracting nodes and edges from JSON]({{ site.github.url }}/images/sna/image9.png)

#### Using CSV

[View this notebook.](http://nbviewer.jupyter.org/github/gwu-libraries/notebooks/blob/master/20170720-building-social-network-graphs-CSV.ipynb)
...
I extracted [nodes]({{ site.github.url }}/resources/nodes.csv) (3,018 nodes) and [edges]({{ site.github.url }}/resources/edges.csv) (3,274 edges) of retweets with a strength greater than 3 from the Elites dataset (json), and we will use these datasets for the rest of this tutorial. 
