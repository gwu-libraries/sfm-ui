    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('harvest_type', models.CharField(max_length=255)),
                ('status', models.CharField(default=b'requested', max_length=20, choices=[(b'requested', b'requested'), (b'completed success', b'completed success'), (b'completed failure', b'completed failure'), (b'running', b'running'), (b'stop requested', b'stop requested')])),
        ...
        migrations.CreateModel(
            ...
            options={
                'diff_fields': ('collection', 'credential', 'harvest_type', 'name', 'description', 'is_active', 'schedule_minutes', 'harvest_options', 'end_date'),
            },
        ),
        migrations.CreateModel(
            name='Warc',
