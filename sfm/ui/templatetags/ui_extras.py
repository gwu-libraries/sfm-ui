...
def render_value_text(value):
    if isinstance(value, dict):
        return render_dict_text(value)
    elif isinstance(value, list):
        return render_list_text(value)
    elif value is True:
        return "Yes"
    elif value is False:
        return "No"
...
def render_list_text(value):
    rend = u""
    for v in value:
        rend += u"* {}\n".format(render_value_text(v))
    return rend
